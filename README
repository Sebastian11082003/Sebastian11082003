# 🚀 ¡Hola! Soy Juan Sebastián Osorio Fierrl
### 🔹 Desarrollador Backend | Fullstack en proceso

![Banner](https://github.com/Sebastian11082003/tu-repo/blob/main/banner.gif?raw=true)

---

## 🌟 Sobre mí

💻 Apasionado por la tecnología y el desarrollo de software. Actualmente trabajando en **backend con TypeScript, NestJS y Node.js**, con miras a convertirlo en un proyecto **fullstack**.
